...
@XmlType(propOrder= {"staffLines", "s1", "s2", "s3", "s4", "s5"})

public class StaffDetailsB5{
	...
	public StaffDetailsB5(List<String> stringTune) {
		...
		s5 = new StaffTuning(5, stringTune.get(4), 2);
	}
